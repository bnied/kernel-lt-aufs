...
#
BuildRequires: asciidoc, bash >= 2.03, bc, binutils >= 2.12, bison, diffutils
BuildRequires: elfutils-devel, findutils, gawk, gcc >= 3.4.2 gzip, hostname, m4
...
%if %{with_perf}
BuildRequires: audit-libs-devel, binutils-devel
BuildRequires: java-1.8.0-openjdk-devel, numactl-devel, perl(ExtUtils::Embed)
BuildRequires: python2, python2-devel, slang-devel, xz-devel, zlib-devel
%endif
%if %{with_tools}
...
- Ensure that objtool is present in the kernel-lt-aufs-devel package
...
- kernel-lt-aufs-tools-libs and kernel-lt-aufs-tools-devel packages.
